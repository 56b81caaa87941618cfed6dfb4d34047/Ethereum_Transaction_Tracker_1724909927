  ...
  <section id="page-details-cards-component" class="py-8 bg-white">
    ...
    <ul id="details-list" class="grid gap-4 min-[480px]:grid-cols-3 text-sm">
      <li id="project-length" class="px-5 py-4 rounded-lg bg-gradient-to-tr from-slate-950 to-slate-800 dark:from-slate-800/80 dark:to-slate-900">
        ...
        <div class="text-slate-400">Monitor Ethereum transactions as they happen, ensuring you never miss a beat in the blockchain world.</div>
      </li>
      <li id="start-date" class="px-5 py-4 rounded-lg bg-gradient-to-tr from-slate-950 to-slate-800 dark:from-slate-800/80 dark:to-slate-900">
        <div class="font-medium text-slate-200" id="start-date-des-1">Customizable Alerts</div>
        <time class="text-slate-400" id="start-time-des-1">Set up personalized notifications for specific addresses, token transfers, or transaction values.</time>
      </li>
      <li id="end-date" class="px-5 py-4 rounded-lg bg-gradient-to-tr from-slate-950 to-slate-800 dark:from-slate-800/80 dark:to-slate-900">
        ...
        <time class="text-slate-400" id="end-time-des-1">Navigate through complex blockchain data with ease, thanks to our intuitive and responsive design.</time>
      </li>
    </ul>
  </section>
</template>
